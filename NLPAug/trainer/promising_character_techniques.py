...
history, model = tensorflow_training_wrapper(mr_train_2, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_mr_2")
history, model = tensorflow_training_wrapper(mr_train_4, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_mr_4")
history, model = tensorflow_training_wrapper(mr_train_6, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_mr_6")
history, model = tensorflow_training_wrapper(mr_train_8, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_mr_8")

history, model = tensorflow_training_wrapper(inserter_train_2, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_inserter_2")
history, model = tensorflow_training_wrapper(inserter_train_4, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_inserter_4")
history, model = tensorflow_training_wrapper(inserter_train_6, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_inserter_6")
history, model = tensorflow_training_wrapper(inserter_train_8, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_inserter_8")

history, model = tensorflow_training_wrapper(misspell_train_2, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_misspell_2")
history, model = tensorflow_training_wrapper(misspell_train_4, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_misspell_4")
history, model = tensorflow_training_wrapper(misspell_train_6, imdb_eval, num_labels=6)
save_hist_model(history, model, "imdb_misspell_6")
history, model = tensorflow_training_wrapper(misspell_train_8, imdb_eval, num_labels=6)
